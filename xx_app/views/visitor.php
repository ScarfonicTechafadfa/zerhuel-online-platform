...
<html>
    <head>
        ...
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/themes/corastore/js/jquery-1.9.1.min.js"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/themes/corastore/js/exporting.js"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/themes/corastore/js/highcharts.js"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/themes/corastore/js/jquery.tsv-0.96.min.js"></script>
    </head>
    <body>
        <div class="clear"></div>
        <div>
